...
if ( $max_value && $min_value === $max_value ) {
	...
	?>
	<div class="quantity">
		<label class="screen-reader-text" for="smntcswcb"><?php esc_html_e( 'Quantidade', 'cesta-app' ); ?></label>
		...
		<input type="number"
					...
					title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'cesta-app' ); ?>"
