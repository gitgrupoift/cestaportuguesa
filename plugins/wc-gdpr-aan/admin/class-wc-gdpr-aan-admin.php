...
class Wc_Gdpr_Aan_Admin {
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) .  'admin/class-wc-gdpr-aan-settings.php';
	}
	...
	public function enqueue_styles($hook) {
		...
		if ( $hook != ('woocommerce_page_wc-gdpr-aan') ) { // Just triggers if is plugin page
		
			return;
		}

		wp_enqueue_style( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'css/wc-gdpr-aan-admin.css', array(), $this->version, 'all' );
	...
	public function enqueue_scripts($hook) {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/wc-gdpr-aan-admin.js', array( 'jquery' ), $this->version, false );
