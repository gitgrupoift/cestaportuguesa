...
class Deactivator {
	...
	public static function deactivate( $network_wide = false ) {
		...
		//Remove five minutes cronjob
		if ( $timestamp = wp_next_scheduled( 'invoicexpress_woocommerce_cron_five_minutes' ) ) {
			wp_unschedule_event( $timestamp, 'invoicexpress_woocommerce_cron_five_minutes' );
		}
	}
}
